...
// 1. Remove the misplaced "Пара 3" block
const misplacedBlock = `    <!-- Пара 3 -->
    <div>
...
html = html.replace(misplacedBlock, '</div>');

// 2. Put it in the right place
const correctBlock = `    <!-- Пара 3 -->
    <div>
        <div class="flex items-center gap-2 mb-1">
            <label for="conviction3" class="block text-sm font-medium text-gray-700">Переконання 3</label>
            <div class="relative flex items-center group z-20">
...
const targetAnchor = `        <label for="touchstone2" class="block text-sm font-medium text-gray-700 mb-1">Опора 2</label>
        <textarea id="touchstone2" name="touchstone2" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2 border resize-y" placeholder="Опора для другого переконання..."></textarea>
    </div>
</div>`;

const replacementAnchor = `        <label for="touchstone2" class="block text-sm font-medium text-gray-700 mb-1">Опора 2</label>
        <textarea id="touchstone2" name="touchstone2" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2 border resize-y" placeholder="Опора для другого переконання..."></textarea>
    </div>
` + correctBlock;

html = html.replace(targetAnchor, replacementAnchor);
