...
const targetGrid = `<div class="grid grid-cols-2 gap-4 mt-6">`;
const replacementGrid = `<div class="grid grid-cols-2 gap-4 mt-6">`; // Wait, I will just do a regex replace to re-layout the grid.

// The issue is that the third pair is outside the grid because the grid was closed early, or it looks weird.
